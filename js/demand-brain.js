...
const DemandBrain = {
  SERVICES: [
    ...
    { name: '広告・集客支援', triggers: ['広告', 'リスティング', 'MEO', 'SEO', '集客', 'Google広告', 'クリック'] },
  ...
  POST_THEMES: {
    ...
    '広告・集客支援': ['沖縄現場業の集客で効く広告の型', '検索広告とMEOの使い分け', '問い合わせが増えた事例の共通点'],
  ...
  SALES_THEMES: {
    ...
    '広告・集客支援': ['集客に課題のある現場業へ広告・集客支援提案', '検索流入が伸びている業種への広告強化提案', 'MEO未対応店舗への露出改善提案'],
