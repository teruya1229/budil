/**
 * Budil v4.11.15 - schedule page completion workflow verification.
 */
...
console.log('== v4.11.15 schedule-page-workflow ==');
...
assert(!receptionJs.includes('renderScheduleTodayList'), 'reception-brain must not change for v4.11.15');
assert(!documentsJs.includes('renderScheduleTodayList'), 'documents-brain must not change for v4.11.15');
assert(!followJs.includes('renderScheduleTodayList'), 'follow-up-brain must not change for v4.11.15');
...
console.log('\nAll v4.11.15 schedule-page-workflow checks passed.');
