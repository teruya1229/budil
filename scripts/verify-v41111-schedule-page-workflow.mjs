/**
 * Budil v4.11.11 - schedule page completion workflow verification.
 */
...
console.log('== v4.11.11 schedule-page-workflow ==');
...
assert(!receptionJs.includes('renderScheduleTodayList'), 'reception-brain must not change for v4.11.11');
assert(!documentsJs.includes('renderScheduleTodayList'), 'documents-brain must not change for v4.11.11');
assert(!followJs.includes('renderScheduleTodayList'), 'follow-up-brain must not change for v4.11.11');
...
console.log('\nAll v4.11.11 schedule-page-workflow checks passed.');
