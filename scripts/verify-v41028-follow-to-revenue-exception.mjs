/**
 * Budil v4.10.32 緊急修正 — 受付/フォローから売上明細例外補助導線 verification.
 */
...
console.log('== v4.10.32 follow-to-revenue-exception ==');
...
assert(indexHtml.includes('css/style.css?v=4.10.32'), 'v4.10.25 documents CSS cache buster must remain');
...
console.log('\nAll v4.10.32 follow-to-revenue-exception checks passed.');
