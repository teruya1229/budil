...
assert(!appJs.includes('data-revenue-check-source'), 'standalone source check action must be removed');
assert(!appJs.includes('openRevenueSourceCheck'), 'openRevenueSourceCheck helper must be removed');
