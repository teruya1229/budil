...
console.log('== version ==');
assert(html.includes('Budil v4.13.16'), 'index shows Budil v4.13.16');
assert(html.includes('js/app.js?v=4.13.16'), 'app.js cache buster v4.13.16');
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.16'"), 'storage v4.13.16');
assert(dataBackup.includes("APP_VERSION: 'v4.13.16'"), 'data-backup v4.13.16');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.16'"), 'verify-current v4.13.16');
