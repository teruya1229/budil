...
console.log('== version ==');
assert(html.includes('Budil v4.13.15'), 'index shows Budil v4.13.15');
assert(html.includes('js/app.js?v=4.13.15'), 'app.js cache buster v4.13.15');
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.15'"), 'storage v4.13.15');
assert(dataBackup.includes("APP_VERSION: 'v4.13.15'"), 'data-backup v4.13.15');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.15'"), 'verify-current v4.13.15');
