...
console.log('== version ==');
assert(html.includes('Budil v4.13.13'), 'index shows Budil v4.13.13');
assert(html.includes('js/app.js?v=4.13.13'), 'app.js cache buster v4.13.13');
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.13'"), 'storage v4.13.13');
assert(dataBackup.includes("APP_VERSION: 'v4.13.13'"), 'data-backup v4.13.13');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.13'"), 'verify-current v4.13.13');
