...
console.log('== version ==');
assert(html.includes('Budil v4.13.14'), 'index shows Budil v4.13.14');
assert(html.includes('js/app.js?v=4.13.14'), 'app.js cache buster v4.13.14');
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.14'"), 'storage v4.13.14');
assert(dataBackup.includes("APP_VERSION: 'v4.13.14'"), 'data-backup v4.13.14');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.14'"), 'verify-current v4.13.14');
