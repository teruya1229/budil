/**
 * Budil v4.10.14 — profit forecast breakdown verification.
 */
...
console.log('== v4.10.14 profit forecast breakdown ==');
...
assert(indexHtml.includes('v4.10.14'), 'index.html should show v4.10.14');
assert(indexHtml.includes('js/app.js?v=4.10.14'), 'app.js cache buster should be v4.10.14');
assert(storageJs.includes("BUDIL_VERSION: 'v4.10.14'"), 'storage.js version should be v4.10.14');
assert(dataBackupJs.includes("APP_VERSION: 'v4.10.14'"), 'data-backup version should be v4.10.14');
...
console.log('== breakdown math (v4.10.13 regression sample) ==');
{
  ...
  assert(result.summary.plannedForecastProfit === 55680, `planned forecast profit should be 55680, got ${result.summary.plannedForecastProfit}`);
  assert(result.summary.totalRevenue === 91100, `total revenue should be 91100, got ${result.summary.totalRevenue}`);
  assert(result.summary.totalProfit === 70860, `total profit should be 70860, got ${result.summary.totalProfit}`);
...
assert(statusMd.includes('v4.10.14'), 'status.md should document v4.10.14');
assert(handoffMd.includes('v4.10.14'), 'handoff.md should document v4.10.14');
assert(decisionLog.includes('v4.10.14'), 'decision-log.md should record v4.10.14');

console.log('All v4.10.14 profit forecast breakdown checks passed.');
