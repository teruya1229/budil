/**
 * Budil v4.11.15 - source profit rates in shared monthly metrics verification.
 */
...
console.log('== v4.11.15 source-profit-rates ==');
...
assert(!receptionJs.includes('getSourceProfitRate'), 'reception-brain must not change for v4.11.15');
assert(!documentsJs.includes('getSourceProfitRate'), 'documents-brain must not change for v4.11.15');
assert(!followJs.includes('getSourceProfitRate'), 'follow-up-brain must not change for v4.11.15');
...
console.log('\nAll v4.11.15 source-profit-rates checks passed.');
