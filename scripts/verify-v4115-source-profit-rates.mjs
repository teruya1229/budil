/**
 * Budil v4.12.0 - source profit rates in shared monthly metrics verification.
 */
...
console.log('== v4.12.0 source-profit-rates ==');
...
assert(!receptionJs.includes('getSourceProfitRate'), 'reception-brain must not change for v4.12.0');
assert(!documentsJs.includes('getSourceProfitRate'), 'documents-brain must not change for v4.12.0');
assert(!followJs.includes('getSourceProfitRate'), 'follow-up-brain must not change for v4.12.0');
...
console.log('\nAll v4.12.0 source-profit-rates checks passed.');
