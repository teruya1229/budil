/**
 * Budil v4.11.9 - source profit rates in shared monthly metrics verification.
 */
...
console.log('== v4.11.9 source-profit-rates ==');
...
assert(indexHtml.includes('js/profit-brain.js?v=4.11.9'), 'profit-brain cache buster should be v4.11.9');
...
assert(!receptionJs.includes('getSourceProfitRate'), 'reception-brain must not change for v4.11.9');
assert(!documentsJs.includes('getSourceProfitRate'), 'documents-brain must not change for v4.11.9');
assert(!followJs.includes('getSourceProfitRate'), 'follow-up-brain must not change for v4.11.9');
...
console.log('\nAll v4.11.9 source-profit-rates checks passed.');
