/**
 * Budil v4.12.1 - source profit rates in shared monthly metrics verification.
 */
...
console.log('== v4.12.1 source-profit-rates ==');
...
assert(indexHtml.includes('js/profit-brain.js?v=4.12.1'), 'profit-brain cache buster should be v4.12.1');
assert(indexHtml.includes('js/executive-brain.js?v=4.12.1'), 'executive-brain cache buster should be v4.12.1');
...
assert(!receptionJs.includes('getSourceProfitRate'), 'reception-brain must not change for v4.12.1');
assert(!documentsJs.includes('getSourceProfitRate'), 'documents-brain must not change for v4.12.1');
assert(!followJs.includes('getSourceProfitRate'), 'follow-up-brain must not change for v4.12.1');
...
console.log('\nAll v4.12.1 source-profit-rates checks passed.');
