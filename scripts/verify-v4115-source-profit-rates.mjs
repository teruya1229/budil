...
assert(indexHtml.includes('js/profit-brain.js?v=4.12.8'), 'profit-brain cache buster should be v4.12.8');
assert(indexHtml.includes('js/executive-brain.js?v=4.12.8'), 'executive-brain cache buster should be v4.12.8');
