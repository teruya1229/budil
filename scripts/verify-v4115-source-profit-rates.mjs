/**
 * Budil v4.12.4 - source profit rates in shared monthly metrics verification.
 */
...
console.log('== v4.12.4 source-profit-rates ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.18'"), 'storage.js version should be v4.13.18');
...
assert(!receptionJs.includes('getSourceProfitRate'), 'reception-brain must not change for v4.12.4');
assert(!documentsJs.includes('getSourceProfitRate'), 'documents-brain must not change for v4.12.4');
assert(!followJs.includes('getSourceProfitRate'), 'follow-up-brain must not change for v4.12.4');
...
console.log('\nAll v4.12.4 source-profit-rates checks passed.');
