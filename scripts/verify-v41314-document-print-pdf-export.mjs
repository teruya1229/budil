/**
 * Budil v4.13.15 - 請求書・見積書の独立印刷とPDFダウンロード
...
assert(index.includes('js/doc-export.js?v=4.13.15'), 'doc-export script is loaded');
...
console.log('\nAll v4.13.15 document print/PDF export checks passed.');
