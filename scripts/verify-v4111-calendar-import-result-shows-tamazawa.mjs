...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.12.19'), 'calendar brain cache buster should be v4.12.19');
...
console.log('== excluded controls remain ==');
{
  ...
  assert(preview.items[0].futureImport.status === 'eligible', 'holiday with amount should remain eligible (v4.12.19 soft override)');
