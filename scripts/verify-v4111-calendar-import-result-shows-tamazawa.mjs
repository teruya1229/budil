...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.12.11'), 'calendar brain cache buster should be v4.12.11');
...
console.log('== excluded controls remain ==');
{
  ...
  assert(preview.items[0].futureImport.status === 'eligible', 'holiday with amount should remain eligible (v4.12.11 soft override)');
