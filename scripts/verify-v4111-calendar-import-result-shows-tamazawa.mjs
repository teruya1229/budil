/**
 * Budil v4.12.3 - calendar import result shows tamazawa candidate verification.
 */
...
console.log('== v4.12.3 calendar-import-result-shows-tamazawa ==');
...
console.log('\nAll v4.12.3 calendar-import-result-shows-tamazawa checks passed.');
