...
assert(storageJs.includes("BUDIL_VERSION: 'v4.10.3'"), 'storage version should be v4.10.3');
assert(dataBackupJs.includes("APP_VERSION: 'v4.10.3'"), 'data-backup version should be v4.10.3');
