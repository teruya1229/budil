...
assert(indexHtml.includes('AI経営脳みそ v4.13.18'), 'header version should be v4.13.18');
assert(indexHtml.includes('Budil v4.13.18'), 'sidebar version should be v4.13.18');
