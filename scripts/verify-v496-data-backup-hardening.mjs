/**
 * Budil v4.10.0 data backup hardening verification.
 */
...
console.log('== v4.10.0 data backup hardening ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.10.0'"), 'storage version should be v4.10.0');
assert(dataBackupJs.includes("APP_VERSION: 'v4.10.0'"), 'data-backup version should be v4.10.0');
...
assert(indexHtml.includes('exec-home-ops-flow'), 'v4.10.0 executive home hierarchy should remain');
...
console.log('All v4.10.0 data backup hardening checks passed.');
