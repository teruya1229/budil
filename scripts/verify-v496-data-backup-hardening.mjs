/**
 * Budil v4.9.7 data backup hardening verification.
 */
...
console.log('== v4.9.7 data backup hardening ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.9.7'"), 'storage version should be v4.9.7');
assert(dataBackupJs.includes("APP_VERSION: 'v4.9.7'"), 'data-backup version should be v4.9.7');
...
assert(indexHtml.includes('exec-home-ops-flow'), 'v4.9.7 executive home hierarchy should remain');
...
console.log('All v4.9.7 data backup hardening checks passed.');
