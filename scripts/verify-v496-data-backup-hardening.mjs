/**
 * Budil v4.9.9 data backup hardening verification.
 */
...
console.log('== v4.9.9 data backup hardening ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.9.9'"), 'storage version should be v4.9.9');
assert(dataBackupJs.includes("APP_VERSION: 'v4.9.9'"), 'data-backup version should be v4.9.9');
...
assert(indexHtml.includes('exec-home-ops-flow'), 'v4.9.9 executive home hierarchy should remain');
...
console.log('All v4.9.9 data backup hardening checks passed.');
