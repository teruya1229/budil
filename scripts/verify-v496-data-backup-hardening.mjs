...
assert(indexHtml.includes('AI\u7d4c\u55b6\u8133\u307f\u305d v4.12.1'), 'header version should be v4.10.10');
assert(indexHtml.includes('Budil v4.12.1'), 'sidebar version should be v4.10.10');
assert(indexHtml.includes('js/app.js?v=4.12.1'), 'app.js cache buster should be v4.10.10');
assert(storageJs.includes("BUDIL_VERSION: 'v4.12.1'"), 'storage version should be v4.10.10');
assert(dataBackupJs.includes("APP_VERSION: 'v4.12.1'"), 'data-backup version should be v4.10.10');
