/**
 * Budil v4.9.8 data backup hardening verification.
 */
...
console.log('== v4.9.8 data backup hardening ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.9.8'"), 'storage version should be v4.9.8');
assert(dataBackupJs.includes("APP_VERSION: 'v4.9.8'"), 'data-backup version should be v4.9.8');
...
assert(indexHtml.includes('exec-home-ops-flow'), 'v4.9.8 executive home hierarchy should remain');
...
console.log('All v4.9.8 data backup hardening checks passed.');
