/**
 * Budil v4.8.28 schedule → revenue confirmation flow verification.
 */
...
console.log('== v4.8.28 schedule to revenue flow ==');
...

{
  ...
  assert(ctx.todayUpcoming === false, 'today schedule should not duplicate in upcoming revenue');
  ...
  assert(ctx.todayQueue === true, 'today schedule should appear in revenue queue');
...
console.log('All v4.8.28 schedule to revenue flow checks passed.');
