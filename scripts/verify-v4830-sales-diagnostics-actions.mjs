/**
 * Budil v4.9.6 sales flow diagnostics action links verification.
 */
...
console.log('== v4.9.6 sales diagnostics actions ==');
...
console.log('All v4.9.6 sales diagnostics action checks passed.');
