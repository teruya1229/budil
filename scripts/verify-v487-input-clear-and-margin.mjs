/**
 * Budil v4.8.11 input clear, margin default, and reception UI verification.
 */
...
console.log('== v4.8.11 input clear and margin check ==');
...
console.log('OK: v4.8.11 input clear, margin defaults, and next-action hiding');
