/**
 * Budil v4.8.9 linked one-to-one safety verification.
 */
...
console.log('== v4.8.9 linked one-to-one check ==');
...
assert(result.exported.appVersion === 'v4.8.9', 'backup appVersion should be v4.8.9');
