/**
 * Budil v4.8.28 linked one-to-one safety verification.
 */
...
console.log('== v4.8.28 linked one-to-one check ==');
...
assert(result.exported.appVersion === 'v4.8.28', 'backup appVersion should be v4.8.28');
