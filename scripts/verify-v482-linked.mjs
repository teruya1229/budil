/**
 * Budil v4.8.29 linked one-to-one safety verification.
 */
...
console.log('== v4.8.29 linked one-to-one check ==');
...
assert(result.exported.appVersion === 'v4.8.29', 'backup appVersion should be v4.8.29');
