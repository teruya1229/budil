/**
 * Budil v4.8.30 linked one-to-one safety verification.
 */
...
console.log('== v4.8.30 linked one-to-one check ==');
...
assert(result.exported.appVersion === 'v4.11.14', 'backup appVersion should be v4.11.14');
