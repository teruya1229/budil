/**
 * Budil v4.12.19 - work order delete + completion payment date defaults.
 */
...
console.log('== v4.12.19 work-order-delete-payment-date ==');
...
assert(indexHtml.includes('js/storage.js?v=4.12.19'), 'storage cache buster should be v4.12.19');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.12.19'), 'work-completion-brain cache buster should be v4.12.19');
...
console.log('\nAll v4.12.19 work-order-delete-payment-date checks passed.');
