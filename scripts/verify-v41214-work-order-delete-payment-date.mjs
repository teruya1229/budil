...
assert(indexHtml.includes('js/storage.js?v=4.13.6'), 'storage cache buster should be v4.13.6');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.13.6'), 'work-completion-brain cache buster should be v4.13.6');
