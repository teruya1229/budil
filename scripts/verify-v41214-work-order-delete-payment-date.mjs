/**
 * Budil v4.12.18 - work order delete + completion payment date defaults.
 */
...
console.log('== v4.12.18 work-order-delete-payment-date ==');
...
assert(indexHtml.includes('js/storage.js?v=4.12.18'), 'storage cache buster should be v4.12.18');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.12.18'), 'work-completion-brain cache buster should be v4.12.18');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.12.18'"), 'verify-current EXPECTED_VERSION should be v4.12.18');
assert(!indexHtml.includes('?v=4.12.14'), 'old cache buster v4.12.14 should be gone');
assert(statusMd.includes('v4.12.18'), 'status.md should document v4.12.18');
assert(handoffMd.includes('v4.12.18'), 'handoff.md should document v4.12.18');
assert(decisionLog.includes('v4.12.18'), 'decision-log.md should record v4.12.18');
...
console.log('\nAll v4.12.18 work-order-delete-payment-date checks passed.');
