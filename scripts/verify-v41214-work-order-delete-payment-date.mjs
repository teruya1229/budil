...
assert(indexHtml.includes('js/storage.js?v=4.13.7'), 'storage cache buster should be v4.13.7');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.13.7'), 'work-completion-brain cache buster should be v4.13.7');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.7'"), 'verify-current EXPECTED_VERSION should be v4.13.7');
