...
assert(indexHtml.includes('js/storage.js?v=4.13.2'), 'storage cache buster should be v4.12.26');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.13.2'), 'work-completion-brain cache buster should be v4.12.26');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.2'"), 'verify-current EXPECTED_VERSION should be v4.12.26');
