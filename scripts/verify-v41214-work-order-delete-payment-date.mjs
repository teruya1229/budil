...
assert(indexHtml.includes('js/storage.js?v=4.12.23'), 'storage cache buster should be v4.12.23');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.12.23'), 'work-completion-brain cache buster should be v4.12.23');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.12.23'"), 'verify-current EXPECTED_VERSION should be v4.12.23');
assert(!indexHtml.includes('?v=4.12.14'), 'old cache buster v4.12.14 should be gone');
assert(statusMd.includes('v4.12.23'), 'status.md should document v4.12.23');
assert(handoffMd.includes('v4.12.23'), 'handoff.md should document v4.12.23');
assert(decisionLog.includes('v4.12.23'), 'decision-log.md should record v4.12.23');
