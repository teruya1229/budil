/**
 * Budil v4.12.14 - work order delete + completion payment date defaults.
 */
...
console.log('== v4.12.14 work-order-delete-payment-date ==');
...
assert(indexHtml.includes('js/storage.js?v=4.12.14'), 'storage cache buster should be v4.12.14');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.12.14'), 'work-completion-brain cache buster should be v4.12.14');
...
assert(!indexHtml.includes('?v=4.12.13'), 'old cache buster v4.12.13 should be gone');
...
console.log('\nAll v4.12.14 work-order-delete-payment-date checks passed.');
