...
assert(indexHtml.includes('js/storage.js?v=4.13.5'), 'storage cache buster should be v4.12.26');
assert(indexHtml.includes('js/work-completion-brain.js?v=4.13.5'), 'work-completion-brain cache buster should be v4.12.26');
