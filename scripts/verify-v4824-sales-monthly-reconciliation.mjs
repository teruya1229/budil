...
assert(indexHtml.includes('AI\u7d4c\u55b6\u8133\u307f\u305d v4.12.4'), 'header version should be v4.8.31');
assert(indexHtml.includes('Budil v4.12.4'), 'sidebar version should be v4.8.31');
assert(indexHtml.includes('js/app.js?v=4.12.4'), 'app.js cache buster should be v4.8.31');
