/**
 * Budil v4.8.26 sales summary monthly reconciliation verification.
 */
...
console.log('== v4.8.26 sales monthly reconciliation ==');
...
console.log('All v4.8.26 sales monthly reconciliation checks passed.');
