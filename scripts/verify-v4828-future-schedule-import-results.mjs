/**
 * Budil v4.8.30 future schedule import result summary verification.
 */
...
console.log('== v4.8.30 future schedule import results ==');
...
assert(calendarBrain.includes('classifyFutureImportCandidate'), 'future import classifier should exist');
...
console.log('All v4.8.30 future schedule import result checks passed.');
