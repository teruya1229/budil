...
assert(index.includes('js/calendar-candidate-brain.js?v=4.13.16'), 'calendar-candidate cache buster is 4.13.16');
assert(index.includes('js/work-order-brain.js?v=4.13.16'), 'work-order-brain cache buster is 4.13.16');
assert(index.includes('js/work-completion-brain.js?v=4.13.16'), 'work-completion-brain cache buster is 4.13.16');
assert(index.includes('js/profit-brain.js?v=4.13.16'), 'profit-brain cache buster is 4.13.16');
...
console.log('\nAll v4.13.16 planned expense checks passed.');
