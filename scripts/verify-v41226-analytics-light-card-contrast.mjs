...
assert(html.includes('css/style.css?v=4.12.26'), 'style.css cache buster is v4.12.26');
assert(html.includes('js/analytics-brain.js?v=4.12.26'), 'analytics-brain.js cache buster is v4.12.26');
