...
assert(html.includes('v4.13.15'), 'index.html shows current version v4.13.15');
assert(html.includes('js/app.js?v=4.13.15'), 'app.js cache buster is current v4.13.15');
assert(html.includes('css/style.css?v=4.13.15'), 'style.css cache buster is current v4.13.15');
assert(html.includes('js/analytics-brain.js?v=4.13.15'), 'analytics-brain.js cache buster is current v4.13.15');
assert(storage.includes("BUDIL_VERSION: 'v4.13.15'"), 'storage version is current v4.13.15');
assert(dataBackup.includes("APP_VERSION: 'v4.13.15'"), 'data-backup version is current v4.13.15');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.15'"), 'verify-current pins current v4.13.15');
