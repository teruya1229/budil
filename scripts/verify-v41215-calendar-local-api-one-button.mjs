/**
 * Budil v4.12.18 - Google Calendar one-button local API sync + auto-save.
 */
...
console.log('== v4.12.18 calendar-local-api-one-button ==');
...
console.log('\nAll v4.12.18 calendar-local-api-one-button checks passed.');
