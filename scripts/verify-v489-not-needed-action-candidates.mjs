/**
 * Budil v4.8.9 not-needed action candidate verification.
 */
...
console.log('== v4.8.9 not-needed action candidate check ==');
...
assert(indexHtml.includes('AI経営脳みそ v4.8.9'), 'header version should be v4.8.9');
assert(indexHtml.includes('Budil v4.8.9'), 'sidebar version should be v4.8.9');
assert(indexHtml.includes('js/app.js?v=4.8.9'), 'app.js cache buster should be v4.8.9');
...
console.log('All v4.8.9 not-needed action candidate checks passed.');
