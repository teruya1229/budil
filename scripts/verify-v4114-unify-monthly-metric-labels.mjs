/**
 * Budil v4.12.0 - unify monthly metric labels across screens verification.
 */
...
console.log('== v4.12.0 unify-monthly-metric-labels ==');
...
console.log('\nAll v4.12.0 unify-monthly-metric-labels checks passed.');
