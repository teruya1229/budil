/**
 * Budil v4.11.15 - monthly close checklist workflow verification.
 */
...
console.log('== v4.11.15 monthly-close-checklist-workflow ==');
...
console.log('== v4.11.5 / v4.11.8 / v4.11.9 / v4.11.10 / v4.11.11 / v4.11.15 maintained ==');
...
assert(appJs.includes('renderFollowUpTodayList'), 'v4.11.15 follow list must remain');
...
console.log('\nAll v4.11.15 monthly-close-checklist-workflow checks passed.');
