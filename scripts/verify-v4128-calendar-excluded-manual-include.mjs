...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.13.11'), 'calendar-candidate cache buster should be v4.13.11');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.11'"), 'storage key namespace unchanged (version only)');
