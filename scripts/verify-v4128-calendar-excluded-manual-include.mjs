...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.12.22'), 'calendar-candidate cache buster should be v4.12.22');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.12.22'"), 'storage key namespace unchanged (version only)');
...
assert(statusMd.includes('verify-current') || handoffMd.includes('verify-current'), 'v4.12.22 verify-current ops retained');
