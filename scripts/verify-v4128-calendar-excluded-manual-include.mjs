/**
 * Budil v4.12.19 - excluded calendar candidates can be manually included as work orders.
 */
...
console.log('== v4.12.19 calendar-excluded-manual-include ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.12.19'"), 'storage key namespace unchanged (version only)');
...
assert(statusMd.includes('verify-current') || handoffMd.includes('verify-current'), 'v4.12.19 verify-current ops retained');

console.log('\nAll v4.12.19 calendar-excluded-manual-include checks passed.');
