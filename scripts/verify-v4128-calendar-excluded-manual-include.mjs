...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.12.23'), 'calendar-candidate cache buster should be v4.12.23');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.12.23'"), 'storage key namespace unchanged (version only)');
...
assert(statusMd.includes('verify-current') || handoffMd.includes('verify-current'), 'v4.12.23 verify-current ops retained');
