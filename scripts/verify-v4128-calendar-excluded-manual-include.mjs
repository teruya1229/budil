...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.13.14'), 'calendar-candidate cache buster should be v4.13.14');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.14'"), 'storage key namespace unchanged (version only)');
