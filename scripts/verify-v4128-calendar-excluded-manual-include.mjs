...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.13.0'), 'calendar-candidate cache buster should be v4.12.26');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.0'"), 'storage key namespace unchanged (version only)');
