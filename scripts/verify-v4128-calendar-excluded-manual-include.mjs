...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.12.27'), 'calendar-candidate cache buster should be v4.12.26');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.12.27'"), 'storage key namespace unchanged (version only)');
