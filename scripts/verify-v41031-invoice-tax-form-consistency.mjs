/**
 * Budil v4.10.32 - invoice form tax consistency verification.
 */
...
console.log('== v4.10.32 invoice-tax-form-consistency ==');
...
assert(indexHtml.includes('css/style.css?v=4.10.32'), 'style.css cache buster should be v4.10.32');
assert(css.includes('v4.10.32'), 'v4.10.32 print layout marker should exist in css');
...
console.log('== v4.10.32 sanitizing maintained ==');
{
  const ctx = createSandbox();
  const revenue = {
    id: 'rev-sanitize',
...
console.log('\nAll v4.10.32 invoice-tax-form-consistency checks passed.');
