/**
 * Budil v4.10.37 - invoice form tax consistency verification.
 */
...
console.log('== v4.10.37 invoice-tax-form-consistency ==');
...
console.log('== v4.10.37 sanitizing maintained ==');
{
  const ctx = createSandbox();
  const revenue = {
    id: 'rev-sanitize',
...
console.log('\nAll v4.10.37 invoice-tax-form-consistency checks passed.');
