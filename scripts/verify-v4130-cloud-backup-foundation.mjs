...
assert(html.includes('AI経営脳みそ v4.13.7'), 'index header version must be v4.13.7');
assert(html.includes('js/budil-cloud.js?v=4.13.7'), 'budil-cloud.js cache buster must be v4.13.7');
assert(storage.includes("BUDIL_VERSION: 'v4.13.7'"), 'storage.js version must be v4.13.7');
assert(dataBackup.includes("APP_VERSION: 'v4.13.7'"), 'data-backup.js version must be v4.13.7');
