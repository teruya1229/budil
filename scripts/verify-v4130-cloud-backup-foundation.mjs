...
assert(html.includes('AI経営脳みそ v4.13.1'), 'index header version must be v4.13.1');
assert(html.includes('js/budil-cloud.js?v=4.13.1'), 'budil-cloud.js cache buster must be v4.13.1');
assert(storage.includes("BUDIL_VERSION: 'v4.13.1'"), 'storage.js version must be v4.13.1');
assert(dataBackup.includes("APP_VERSION: 'v4.13.1'"), 'data-backup.js version must be v4.13.1');
...
console.log(`\nAll v4.13.1 cloud-backup-foundation checks passed.`);
