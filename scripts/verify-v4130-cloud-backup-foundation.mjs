...
assert(html.includes('AI経営脳みそ v4.13.14'), 'index header version must be v4.13.14');
assert(html.includes('js/budil-cloud.js?v=4.13.14'), 'budil-cloud.js cache buster must be v4.13.14');
assert(storage.includes("BUDIL_VERSION: 'v4.13.14'"), 'storage.js version must be v4.13.14');
assert(dataBackup.includes("APP_VERSION: 'v4.13.14'"), 'data-backup.js version must be v4.13.14');
