...
assert(html.includes('AI経営脳みそ v4.13.0'), 'index header version must be v4.13.0');
assert(html.includes('js/budil-cloud.js?v=4.13.0'), 'budil-cloud.js cache buster must be v4.13.0');
assert(storage.includes("BUDIL_VERSION: 'v4.13.0'"), 'storage.js version must be v4.13.0');
assert(dataBackup.includes("APP_VERSION: 'v4.13.0'"), 'data-backup.js version must be v4.13.0');
...
console.log(`\nAll v4.13.0 cloud-backup-foundation checks passed.`);
