...
assert(indexHtml.includes('js/storage.js?v=4.13.15'), 'storage cache buster should be v4.13.15');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.15'"), 'verify-current EXPECTED_VERSION should be v4.13.15');
