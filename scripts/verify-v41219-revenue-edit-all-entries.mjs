...
assert(indexHtml.includes('js/storage.js?v=4.13.10'), 'storage cache buster should be v4.13.10');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.10'"), 'verify-current EXPECTED_VERSION should be v4.13.10');
