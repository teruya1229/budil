...
assert(indexHtml.includes('js/storage.js?v=4.13.16'), 'storage cache buster should be v4.13.16');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.16'"), 'verify-current EXPECTED_VERSION should be v4.13.16');
