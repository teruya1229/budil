...
assert(indexHtml.includes('js/storage.js?v=4.13.17'), 'storage cache buster should be v4.13.17');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.17'"), 'verify-current EXPECTED_VERSION should be v4.13.17');
