...
assert(indexHtml.includes('js/storage.js?v=4.13.12'), 'storage cache buster should be v4.13.12');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.12'"), 'verify-current EXPECTED_VERSION should be v4.13.12');
