/**
 * Budil v4.13.15 - 売上確定時の複数経費を一括・全件成功で保存
...
assert(index.includes('js/storage.js?v=4.13.15'), 'storage.js cache buster is 4.13.15');
...
console.log('\nAll v4.13.15 atomic inline expense checks passed.');
