/**
 * Budil v4.13.14 - 売上確定時の複数経費を一括・全件成功で保存
...
assert(index.includes('js/storage.js?v=4.13.14'), 'storage.js cache buster is 4.13.14');
...
console.log('\nAll v4.13.14 atomic inline expense checks passed.');
