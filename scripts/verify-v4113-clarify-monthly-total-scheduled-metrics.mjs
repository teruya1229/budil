/**
 * Budil v4.11.13 - clarify monthly total and scheduled metrics verification.
 */
...
console.log('== v4.11.13 clarify-monthly-total-scheduled-metrics ==');
...
console.log('\nAll v4.11.13 clarify-monthly-total-scheduled-metrics checks passed.');
