/**
 * Budil v4.12.19 - remove redundant revenue-row source action.
...
console.log('== v4.12.19 remove-revenue-source-row-action ==');
...
console.log('\nAll v4.12.19 remove-revenue-source-row-action checks passed.');
