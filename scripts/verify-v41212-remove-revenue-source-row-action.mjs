/**
 * Budil v4.12.12 - remove redundant revenue-row source action.
...
console.log('== v4.12.12 remove-revenue-source-row-action ==');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.12.12'"), 'verify-current EXPECTED_VERSION should be v4.12.12');
...
console.log('\nAll v4.12.12 remove-revenue-source-row-action checks passed.');
