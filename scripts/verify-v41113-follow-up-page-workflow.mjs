/**
 * Budil v4.11.14 - follow-up page action workflow verification.
 */
...
console.log('== v4.11.14 follow-up-page-workflow ==');
...
assert(indexHtml.includes('js/follow-up-brain.js?v=4.11.14'), 'follow-up-brain cache buster should be v4.11.14');
...
console.log('== v4.11.5 / v4.11.8 / v4.11.10 / v4.11.14 maintained ==');
...
assert(!documentsJs.includes('v4.11.14'), 'documents-brain should not be version-bumped');
assert(!receptionJs.includes('v4.11.14'), 'reception-brain should not be changed');
...
console.log('\nAll v4.11.14 follow-up-page-workflow checks passed.');
