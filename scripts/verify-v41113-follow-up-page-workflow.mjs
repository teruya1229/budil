/**
 * Budil v4.11.13 - follow-up page action workflow verification.
 */
...
console.log('== v4.11.13 follow-up-page-workflow ==');
...
assert(indexHtml.includes('js/follow-up-brain.js?v=4.11.13'), 'follow-up-brain cache buster should be v4.11.13');
...
console.log('== v4.11.5 / v4.11.8 / v4.11.10 / v4.11.13 maintained ==');
...
assert(!documentsJs.includes('v4.11.13'), 'documents-brain should not be version-bumped');
assert(!receptionJs.includes('v4.11.13'), 'reception-brain should not be changed');
...
console.log('\nAll v4.11.13 follow-up-page-workflow checks passed.');
