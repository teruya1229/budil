...
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.10.5'"), 'storage version should be v4.10.5');
...
assert(indexHtml.includes('exec-home-daily-core'), 'v4.10.5 executive home daily core should exist');
assert(indexHtml.includes('exec-home-next-action'), 'v4.10.5 executive home next action should exist');
