...
assert(indexHtml.includes('AI\u7d4c\u55b6\u8133\u307f\u305d v4.10.11'), 'header version should be v4.10.11');
assert(indexHtml.includes('Budil v4.10.11'), 'sidebar version should be v4.10.11');
assert(indexHtml.includes('js/app.js?v=4.10.11'), 'app.js cache buster should be v4.10.11');
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.10.11'"), 'storage version should be v4.10.11');
...
assert(indexHtml.includes('exec-home-daily-core'), 'v4.10.11 executive home daily core should exist');
assert(indexHtml.includes('exec-home-next-action'), 'v4.10.11 executive home next action should exist');
