...
assert(indexHtml.includes('exec-home-daily-core'), 'v4.10.10 executive home daily core should exist');
assert(indexHtml.includes('exec-home-next-action'), 'v4.10.10 executive home next action should exist');
