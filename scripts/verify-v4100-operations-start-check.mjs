...
assert(indexHtml.includes('AI経営脳みそ v4.10.32'), 'header version should be v4.10.27');
assert(indexHtml.includes('Budil v4.10.32'), 'sidebar version should be v4.10.27');
assert(indexHtml.includes('js/app.js?v=4.10.32'), 'app.js cache buster should be v4.10.32');
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.10.32'"), 'storage version should be v4.10.32');
