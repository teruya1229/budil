...
assert(indexHtml.includes('AI経営脳みそ v4.10.30'), 'header version should be v4.10.27');
assert(indexHtml.includes('Budil v4.10.30'), 'sidebar version should be v4.10.27');
assert(indexHtml.includes('js/app.js?v=4.10.30'), 'app.js cache buster should be v4.10.30');
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.10.30'"), 'storage version should be v4.10.30');
