...
assert(indexHtml.includes('AI経営脳みそ v4.13.5'), 'header version should be v4.13.5');
assert(indexHtml.includes('Budil v4.13.5'), 'sidebar version should be v4.13.5');
assert(indexHtml.includes('js/app.js?v=4.13.5'), 'app.js cache buster should be v4.12.26');
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.13.5'"), 'storage version should be v4.12.26');
