...
assert(indexHtml.includes('AI経営脳みそ v4.13.10'), 'header version should be v4.13.10');
assert(indexHtml.includes('Budil v4.13.10'), 'sidebar version should be v4.13.10');
assert(indexHtml.includes('js/app.js?v=4.13.10'), 'app.js cache buster should be v4.13.10');
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.13.10'"), 'storage version should be v4.13.10');
