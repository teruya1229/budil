...
assert(indexHtml.includes('AI\u7d4c\u55b6\u8133\u307f\u305d v4.10.18'), 'header version should be v4.10.18');
assert(indexHtml.includes('Budil v4.10.18'), 'sidebar version should be v4.10.18');
assert(indexHtml.includes('js/app.js?v=4.10.18'), 'app.js cache buster should be v4.10.18');
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.10.18'"), 'storage version should be v4.10.18');
...
assert(indexHtml.includes('exec-home-daily-core'), 'v4.10.18 executive home daily core should exist');
assert(indexHtml.includes('exec-home-next-action'), 'v4.10.18 executive home next action should exist');
