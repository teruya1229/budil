...
assert(indexHtml.includes('AI\u7d4c\u55b6\u8133\u307f\u305d v4.10.23'), 'header version should be v4.10.23');
assert(indexHtml.includes('Budil v4.10.23'), 'sidebar version should be v4.10.23');
assert(indexHtml.includes('js/app.js?v=4.10.23'), 'app.js cache buster should be v4.10.23');
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.10.23'"), 'storage version should be v4.10.23');
