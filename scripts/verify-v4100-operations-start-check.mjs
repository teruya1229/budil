...
assert(indexHtml.includes('AI経営脳みそ v4.12.5'), 'header version should be v4.12.4');
...
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.12.5'"), 'storage version should be v4.12.4');
