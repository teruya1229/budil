/**
 * Budil v4.11.12 - reception list next-action workflow verification.
 */
...
console.log('== v4.11.12 reception-list-next-action ==');
...
assert(indexHtml.includes('js/reception-brain.js?v=4.11.12'), 'reception-brain cache buster should be v4.11.12');
...
console.log('== v4.10.39 / v4.11.10 / v4.11.12 maintained ==');
...
assert(!documentsJs.includes('v4.11.12'), 'documents-brain should not be version-bumped');
assert(!followJs.includes('v4.11.12'), 'follow-up-brain should not be changed');
...
console.log('\nAll v4.11.12 reception-list-next-action checks passed.');
