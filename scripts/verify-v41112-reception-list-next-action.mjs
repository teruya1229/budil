/**
 * Budil v4.11.14 - reception list next-action workflow verification.
 */
...
console.log('== v4.11.14 reception-list-next-action ==');
...
assert(indexHtml.includes('js/reception-brain.js?v=4.11.14'), 'reception-brain cache buster should be v4.11.14');
...
console.log('== v4.10.39 / v4.11.10 / v4.11.14 maintained ==');
...
console.log('\nAll v4.11.14 reception-list-next-action checks passed.');
