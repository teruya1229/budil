/**
 * Budil v4.10.11 — calendar import vs upcoming schedule consistency verification.
 */
...
console.log('== v4.10.11 calendar schedule consistency ==');
...
assert(indexHtml.includes('v4.10.11'), 'index.html should show v4.10.11');
assert(indexHtml.includes('js/app.js?v=4.10.11'), 'app.js cache buster should be v4.10.11');
assert(storageJs.includes("BUDIL_VERSION: 'v4.10.11'"), 'storage.js version should be v4.10.11');
assert(dataBackupJs.includes("APP_VERSION: 'v4.10.11'"), 'data-backup version should be v4.10.11');
...
assert(statusMd.includes('v4.10.11'), 'status.md should document v4.10.11');
assert(handoffMd.includes('v4.10.11'), 'handoff.md should document v4.10.11');
assert(decisionLog.includes('v4.10.11'), 'decision-log.md should record v4.10.11');

execSync('node scripts/verify-v41010-final-hard-polish.mjs', { cwd: root, stdio: 'inherit' });

console.log('All v4.10.11 calendar schedule consistency checks passed.');
