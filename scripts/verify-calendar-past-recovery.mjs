...
assert(indexHtml.includes('Budil v4.12.4'), 'sidebar version should be v4.12.4');
...
assert(indexHtml.includes('\u767b\u9332\u5bfe\u8c61\u3092\u58f2\u4e0a\u78ba\u5b9a'), 'bulk convert button label should exist');
assert(indexHtml.includes('\u4e00\u62ec\u58f2\u4e0a\u78ba\u5b9a\u306e\u524d\u306b\u5b89\u5168\u30d0\u30c3\u30af\u30a2\u30c3\u30d7\u3092\u4f5c\u6210\u3057\u307e\u3059'), 'past recovery safety backup note should exist');
...
assert(indexHtml.includes('\u767b\u9332\u5bfe\u8c61\u304c0\u4ef6\u306e\u3068\u304d\u306f\u4e00\u62ec\u58f2\u4e0a\u78ba\u5b9a\u3067\u304d\u307e\u305b\u3093'), 'past recovery zero-candidate note should exist');
