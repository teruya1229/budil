/**
 * Budil v4.10.34 - invoice/estimate Money Forward-like layout verification.
 */
...
console.log('== v4.10.34 invoice-moneyforward-like-layout ==');
...
assert(documentsJs.includes('doc-company'), 'company block should exist');
assert(documentsJs.includes('doc-company-name'), 'company name line should exist');
assert(documentsJs.includes('doc-meta-info'), 'meta info block should exist');
assert(documentsJs.includes('doc-meta-sep'), 'meta colon separator should exist');
assert(documentsJs.includes('doc-framed-block'), 'framed block class should exist');
assert(documentsJs.includes('doc-sheet-footer'), 'footer wrapper should exist');
assert(!documentsJs.includes('税率別内訳'), 'tax breakdown table must not be rendered');

console.log('== CSS layout ==');
assert(css.includes('.doc-company'), 'company CSS should exist');
...
assert(css.includes('body.doc-printing .doc-company'), 'print company CSS should exist');
assert(css.includes('body.doc-printing .doc-framed-block'), 'print framed block CSS should exist');
assert(css.includes('body.doc-printing .doc-sheet-footer'), 'print footer CSS should exist');
assert(css.includes('v4.10.34'), 'v4.10.34 layout marker should exist in css');
assert(!css.match(/\/\* v4\.10\.34[\s\S]*#view-dashboard/),
  'v4.10.34 doc layout block must not modify dashboard CSS');
...
console.log('== rendered layout ==');
{
  ...
  assert(result.html.includes('doc-company'), 'sheet should include company block');
...
console.log('\nAll v4.10.34 invoice-moneyforward-like-layout checks passed.');
