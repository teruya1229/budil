/**
 * Budil v4.9.0 sales operations MVP final polish verification.
 */
...
console.log('== v4.9.0 sales operations MVP ==');
...
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.9.0'"), 'storage version should be v4.9.0');
...
console.log('All v4.9.0 sales operations MVP checks passed.');
