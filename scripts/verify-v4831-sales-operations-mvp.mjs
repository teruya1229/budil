/**
 * Budil v4.8.31 sales operations MVP final polish verification.
 */
...
console.log('== v4.8.31 sales operations MVP ==');
...
assert(load('js/storage.js').includes("BUDIL_VERSION: 'v4.8.31'"), 'storage version should be v4.8.31');
...
console.log('All v4.8.31 sales operations MVP checks passed.');
