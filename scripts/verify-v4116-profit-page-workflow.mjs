/**
 * Budil v4.11.6 - profit page workflow and schedule edit actions verification.
 */
...
console.log('== v4.11.6 profit-page-workflow ==');
...
assert(indexHtml.includes('css/style.css?v=4.11.6'), 'style.css cache buster should be v4.11.6');
...
assert(!receptionJs.includes('renderProfitUpcomingSchedule'), 'reception-brain must not change for v4.11.6');
assert(!documentsJs.includes('renderProfitUpcomingSchedule'), 'documents-brain must not change for v4.11.6');
assert(!followJs.includes('renderProfitUpcomingSchedule'), 'follow-up-brain must not change for v4.11.6');
...
console.log('\nAll v4.11.6 profit-page-workflow checks passed.');
