...
assert(html.includes('js/analytics-brain.js?v=4.13.13'), 'analytics-brain.js cache buster is v4.13.13');
...
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.13'"), 'verify-current pins v4.12.26');
