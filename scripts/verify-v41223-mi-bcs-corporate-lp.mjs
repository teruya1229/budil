...
assert(html.includes('v4.13.10'), 'index.html shows v4.12.26');
...
assert(html.includes('js/analytics-brain.js?v=4.13.10'), 'analytics-brain.js cache buster is v4.13.10');
