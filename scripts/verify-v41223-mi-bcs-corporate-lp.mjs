...
assert(html.includes('v4.13.3'), 'index.html shows v4.12.26');
assert(html.includes('js/app.js?v=4.13.3'), 'app.js cache buster is v4.12.26');
assert(html.includes('css/style.css?v=4.13.3'), 'style.css cache buster is v4.12.26');
assert(html.includes('js/analytics-brain.js?v=4.13.3'), 'analytics-brain.js cache buster is v4.12.26');
assert(storage.includes("BUDIL_VERSION: 'v4.13.3'"), 'storage version is v4.12.26');
assert(dataBackup.includes("APP_VERSION: 'v4.13.3'"), 'data-backup version is v4.12.26');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.3'"), 'verify-current pins v4.12.26');
