/**
 * Budil v4.10.34 - invoice/estimate tax display mode verification.
 */
...
console.log('== v4.10.34 invoice-tax-display-mode ==');
...
console.log('\nAll v4.10.34 invoice-tax-display-mode checks passed.');
