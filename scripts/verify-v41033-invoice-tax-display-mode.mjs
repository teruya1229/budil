/**
 * Budil v4.10.35 - invoice/estimate tax display mode verification.
 */
...
console.log('== v4.10.35 invoice-tax-display-mode ==');
...
console.log('\nAll v4.10.35 invoice-tax-display-mode checks passed.');
