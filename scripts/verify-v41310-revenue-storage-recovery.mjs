/**
 * Budil v4.13.18 - recover legacy calendar originalText before revenue confirmation.
...
assert(indexHtml.includes('Budil v4.13.18'), 'screen version is v4.13.18');
assert(indexHtml.includes('js/app.js?v=4.13.18'), 'app cache buster is v4.13.18');
assert(indexHtml.includes('css/style.css?v=4.13.18'), 'css cache buster is v4.13.18');
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.18'"), 'Storage version is v4.13.18');
assert(dataBackupJs.includes("APP_VERSION: 'v4.13.18'"), 'backup version is v4.13.18');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.18'"), 'current runner pins v4.13.18');
...
console.log('\nAll v4.13.18 revenue storage recovery checks passed.');
