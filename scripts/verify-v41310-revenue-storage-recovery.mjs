/**
 * Budil v4.13.14 - recover legacy calendar originalText before revenue confirmation.
...
assert(indexHtml.includes('Budil v4.13.14'), 'screen version is v4.13.14');
assert(indexHtml.includes('js/app.js?v=4.13.14'), 'app cache buster is v4.13.14');
assert(indexHtml.includes('css/style.css?v=4.13.14'), 'css cache buster is v4.13.14');
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.14'"), 'Storage version is v4.13.14');
assert(dataBackupJs.includes("APP_VERSION: 'v4.13.14'"), 'backup version is v4.13.14');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.14'"), 'current runner pins v4.13.14');
...
console.log('\nAll v4.13.14 revenue storage recovery checks passed.');
