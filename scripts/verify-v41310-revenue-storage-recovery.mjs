/**
 * Budil v4.13.15 - recover legacy calendar originalText before revenue confirmation.
...
assert(indexHtml.includes('Budil v4.13.15'), 'screen version is v4.13.15');
assert(indexHtml.includes('js/app.js?v=4.13.15'), 'app cache buster is v4.13.15');
assert(indexHtml.includes('css/style.css?v=4.13.15'), 'css cache buster is v4.13.15');
assert(storageJs.includes("BUDIL_VERSION: 'v4.13.15'"), 'Storage version is v4.13.15');
assert(dataBackupJs.includes("APP_VERSION: 'v4.13.15'"), 'backup version is v4.13.15');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.13.15'"), 'current runner pins v4.13.15');
...
console.log('\nAll v4.13.15 revenue storage recovery checks passed.');
