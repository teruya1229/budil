/**
 * Budil v4.10.13 — revenue duplicate guard verification.
 */
...
console.log('== v4.10.13 revenue duplicate guards ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.10.13'"), 'storage.js version should be v4.10.13');
assert(dataBackupJs.includes("APP_VERSION: 'v4.10.13'"), 'data-backup version should be v4.10.13');
...
console.log('== v4.10.13 calendar schedule consistency (regression) ==');
{
  const ctx = createSandbox();
...
console.log('All v4.10.13 revenue duplicate guard checks passed.');
