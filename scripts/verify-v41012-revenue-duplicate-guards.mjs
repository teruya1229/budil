/**
 * Budil v4.10.12 — revenue duplicate guard verification.
 */
...
console.log('== v4.10.12 revenue duplicate guards ==');
...
assert(storageJs.includes("BUDIL_VERSION: 'v4.10.12'"), 'storage.js version should be v4.10.12');
assert(dataBackupJs.includes("APP_VERSION: 'v4.10.12'"), 'data-backup version should be v4.10.12');
...
console.log('== v4.10.12 calendar schedule consistency (regression) ==');
{
  const ctx = createSandbox();
...
console.log('All v4.10.12 revenue duplicate guard checks passed.');
