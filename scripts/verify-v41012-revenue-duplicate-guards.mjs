/**
 * Budil v4.10.18 — revenue duplicate guard verification.
 */
...
console.log('== v4.10.18 revenue duplicate guards ==');
...
console.log('== v4.10.18 calendar schedule consistency (regression) ==');
{
  const ctx = createSandbox();
...
console.log('All v4.10.18 revenue duplicate guard checks passed.');
