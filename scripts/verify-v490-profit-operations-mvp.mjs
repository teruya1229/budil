/**
 * Budil v4.10.1 profit operations MVP verification.
 */
...
assert(indexHtml.includes('\u7d4c\u8cbb\u5165\u529b\u306e\u9806'), 'profit view subtitle should describe workflow');
...
console.log('All v4.10.1 profit operations MVP checks passed.');
