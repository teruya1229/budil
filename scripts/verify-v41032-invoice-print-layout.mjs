/**
 * Budil v4.10.36 - invoice/estimate print layout verification.
 */
...
console.log('== v4.10.36 invoice-print-layout ==');
...
console.log('== v4.10.36 tax consistency maintained ==');
...
console.log('\nAll v4.10.36 invoice-print-layout checks passed.');
