...
assert(html.includes('js/revenue-brain.js?v=4.13.18'), 'revenue-brain.js cache buster is v4.13.18');
assert(html.includes('css/style.css?v=4.13.18'), 'style.css cache buster is v4.13.18');
assert(storage.includes("BUDIL_VERSION: 'v4.13.18'"), 'storage version is v4.13.18');
...
assert(handoffMd.includes('v4.13.18') && handoffMd.includes('直受け'),
  'handoff.md mentions v4.13.18 直受け');
assert(decisionLog.includes('v4.13.18') && (decisionLog.includes('売上確定') || decisionLog.includes('work-completion')),
  'decision-log records v4.13.18 completion duplicate');
