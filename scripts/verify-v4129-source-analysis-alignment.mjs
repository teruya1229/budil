/**
 * Budil v4.12.11 - revenue source analysis display aligned with profit rates.
 */
...
console.log('== v4.12.11 source-analysis-alignment ==');
...
assert(indexHtml.includes('js/revenue-summary-brain.js?v=4.12.11'), 'revenue-summary-brain cache buster should be v4.12.11');
...
console.log('\nAll v4.12.11 source-analysis-alignment checks passed.');
