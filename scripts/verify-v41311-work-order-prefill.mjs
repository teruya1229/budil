/**
 * Budil v4.13.15 - work-order 売上確定へ must prefill scheduled fields.
...
assert(index.includes('js/app.js?v=4.13.15'), 'app.js cache buster is v4.13.15');
...
console.log('\nAll v4.13.15 work-order prefill checks passed.');
