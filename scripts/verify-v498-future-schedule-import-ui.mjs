/**
 * Budil v4.9.8 future schedule import UI-flow verification.
...
console.log('== v4.9.8 future schedule import UI flow ==');
...
console.log('All v4.9.8 future schedule import UI flow checks passed.');
