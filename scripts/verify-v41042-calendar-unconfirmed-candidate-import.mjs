/**
 * Budil v4.10.42 - calendar unconfirmed candidate import verification.
 *
 * 玉澤 真理子様ケース:
...
console.log('== v4.10.42 calendar-unconfirmed-candidate-import ==');
...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.10.42'), 'calendar brain cache buster should be v4.10.42');
...
console.log('== v4.10.42 brain markers ==');
assert(calBrainJs.includes('v4.10.42'), 'calendar-candidate-brain.js should include v4.10.42 marker');
...
assert(!css.includes('v4.10.42'), 'css/style.css must not change for v4.10.42');
...
console.log('\nAll v4.10.42 calendar-unconfirmed-candidate-import checks passed.');
