/**
 * Budil v4.11.0 - calendar unconfirmed candidate import verification.
 *
 * 玉澤 真理子様ケース:
...
console.log('== v4.11.0 calendar-unconfirmed-candidate-import ==');
...
assert(indexHtml.includes('js/calendar-candidate-brain.js?v=4.11.0'), 'calendar brain cache buster should be v4.11.0');
...
console.log('== v4.11.0 brain markers ==');
assert(calBrainJs.includes('v4.11.0'), 'calendar-candidate-brain.js should include v4.11.0 marker');
...
assert(!css.includes('v4.11.0'), 'css/style.css must not change for v4.11.0');
...
console.log('\nAll v4.11.0 calendar-unconfirmed-candidate-import checks passed.');
