/**
 * Budil v4.11.2 - calendar unconfirmed candidate import verification.
 *
 * 玉澤 真理子様ケース:
...
console.log('== v4.11.2 calendar-unconfirmed-candidate-import ==');
...
console.log('== v4.11.2 brain markers ==');
...
assert(!css.includes('v4.11.2'), 'css/style.css must not change for v4.11.2');
...
console.log('\nAll v4.11.2 calendar-unconfirmed-candidate-import checks passed.');
