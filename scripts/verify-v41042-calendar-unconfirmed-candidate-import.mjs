/**
 * Budil v4.11.1 - calendar unconfirmed candidate import verification.
 *
 * 玉澤 真理子様ケース:
...
console.log('== v4.11.1 calendar-unconfirmed-candidate-import ==');
...
console.log('== v4.11.1 brain markers ==');
...
assert(!css.includes('v4.11.1'), 'css/style.css must not change for v4.11.1');
...
console.log('\nAll v4.11.1 calendar-unconfirmed-candidate-import checks passed.');
