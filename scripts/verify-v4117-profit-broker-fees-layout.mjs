/**
 * Budil v4.11.10 - broker fees visibility and profit metrics layout verification.
 */
...
console.log('== v4.11.10 profit-broker-fees-layout ==');
...
console.log('== v4.11.10 workflow preserved ==');
...
assert(!receptionJs.includes('confirmedFeeAmount'), 'reception-brain must not change for v4.11.10');
assert(!documentsJs.includes('confirmedFeeAmount'), 'documents-brain must not change for v4.11.10');
assert(!followJs.includes('confirmedFeeAmount'), 'follow-up-brain must not change for v4.11.10');
...
console.log('\nAll v4.11.10 profit-broker-fees-layout checks passed.');
