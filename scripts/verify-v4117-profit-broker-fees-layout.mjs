/**
 * Budil v4.12.4 - broker fees visibility and profit metrics layout verification.
 */
...
console.log('== v4.12.4 profit-broker-fees-layout ==');
...
console.log('== v4.12.4 workflow preserved ==');
...
assert(!receptionJs.includes('confirmedFeeAmount'), 'reception-brain must not change for v4.12.4');
assert(!documentsJs.includes('confirmedFeeAmount'), 'documents-brain must not change for v4.12.4');
assert(!followJs.includes('confirmedFeeAmount'), 'follow-up-brain must not change for v4.12.4');
...
console.log('\nAll v4.12.4 profit-broker-fees-layout checks passed.');
