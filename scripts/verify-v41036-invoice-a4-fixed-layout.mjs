/**
 * Budil v4.10.36 - invoice/estimate A4 fixed layout verification.
 */
...
console.log('== v4.10.36 invoice-a4-fixed-layout ==');
...
console.log('\nAll v4.10.36 invoice-a4-fixed-layout checks passed.');
