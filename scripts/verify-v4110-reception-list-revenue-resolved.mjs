/**
 * Budil v4.11.0 - reception list revenue resolved display verification.
 */
...
console.log('== v4.11.0 reception-list-revenue-resolved ==');
...
assert(indexHtml.includes('js/reception-brain.js?v=4.11.0'), 'reception-brain cache buster should be v4.11.0');
assert(indexHtml.includes('js/revenue-brain.js?v=4.11.0'), 'revenue-brain cache buster should be v4.11.0');
...
assert(!css.includes('v4.11.0'), 'css must not change for v4.11.0');
...
console.log('\nAll v4.11.0 reception-list-revenue-resolved checks passed.');
