/**
 * Budil v4.11.1 - reception list revenue resolved display verification.
 */
...
console.log('== v4.11.1 reception-list-revenue-resolved ==');
...
assert(indexHtml.includes('js/revenue-brain.js?v=4.11.0'), 'revenue-brain cache buster should remain v4.11.0');
...
console.log('\nAll v4.11.1 reception-list-revenue-resolved checks passed.');
