...
console.log('== v4.12.4 reception-list-revenue-resolved ==');
...
assert(indexHtml.includes('js/reception-brain.js?v=4.13.18'), 'reception-brain cache buster should remain v4.11.0');
...
console.log('\nAll v4.12.4 reception-list-revenue-resolved checks passed.');
