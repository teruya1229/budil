/**
 * Budil v4.12.3 - reception list revenue resolved display verification.
 */
...
console.log('== v4.12.3 reception-list-revenue-resolved ==');
...
console.log('\nAll v4.12.3 reception-list-revenue-resolved checks passed.');
