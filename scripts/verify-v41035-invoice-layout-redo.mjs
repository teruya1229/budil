/**
 * Budil v4.10.38 - invoice layout redo verification.
 */
...
console.log('== v4.10.38 invoice-layout-redo ==');
...
assert(indexHtml.includes('css/style.css?v=4.13.18'), 'style.css cache buster should be v4.10.41');
assert(indexHtml.includes('js/documents-brain.js?v=4.13.18'), 'documents-brain cache buster should be v4.13.18');
...
console.log('\nAll v4.10.38 invoice-layout-redo checks passed.');
