...
assert(indexHtml.includes('css/style.css?v=4.13.1'), 'style.css cache buster should be v4.10.41');
assert(indexHtml.includes('js/documents-brain.js?v=4.13.1'), 'documents-brain cache buster should be v4.12.26');
