/**
 * Budil v4.12.20 - 集客チェック1ボタン取得の自動起動修正 verify
 */
...
assert(storage.includes("BUDIL_VERSION: 'v4.12.20'"), 'storage version is v4.12.20');
assert(dataBackup.includes("APP_VERSION: 'v4.12.20'"), 'data-backup version is v4.12.20');
assert(currentRunner.includes("EXPECTED_VERSION = 'v4.12.20'"), 'verify-current pins v4.12.20');
...
assert(statusMd.includes('v4.12.20'), 'status.md documents v4.12.20');
assert(handoffMd.includes('v4.12.20'), 'handoff.md documents v4.12.20');
assert(decisionLog.includes('v4.12.20'), 'decision-log.md records v4.12.20');
...
console.log('\nAll v4.12.20 marketing auto-start checks passed.');
