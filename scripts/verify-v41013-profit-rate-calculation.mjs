/**
 * Budil v4.10.15 — gross margin rate profit calculation verification.
 */
...
console.log('== v4.10.15 profit rate calculation ==');
...
console.log('All v4.10.15 profit rate calculation checks passed.');
