/**
 * Budil v4.9.7 daily expense input verification.
 */
...
console.log('== v4.9.7 daily expense input ==');
...
assert(appJs.includes('getRevenueConfirmationWorkOrderIds'), 'v4.9.7 revenue hardening should remain');
...
console.log('All v4.9.7 daily expense input checks passed.');
