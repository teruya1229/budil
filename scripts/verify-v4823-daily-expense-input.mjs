/**
 * Budil v4.8.24 daily expense input verification.
 */
...
console.log('== v4.8.24 daily expense input ==');
...
assert(appJs.includes('getRevenueConfirmationWorkOrderIds'), 'v4.8.24 revenue hardening should remain');
...
console.log('All v4.8.24 daily expense input checks passed.');
