/**
 * Budil v4.8.23 daily expense input verification.
 */
...
console.log('== v4.8.23 daily expense input ==');
...
assert(appJs.includes('getRevenueConfirmationWorkOrderIds'), 'v4.8.23 revenue hardening should remain');
...
console.log('All v4.8.23 daily expense input checks passed.');
