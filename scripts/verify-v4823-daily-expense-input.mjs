/**
 * Budil v4.10.0 daily expense input verification.
 */
...
console.log('== v4.10.0 daily expense input ==');
...
assert(appJs.includes('getRevenueConfirmationWorkOrderIds'), 'v4.10.0 revenue hardening should remain');
...
console.log('All v4.10.0 daily expense input checks passed.');
