/**
 * Budil v4.10.1 daily expense input verification.
 */
...
assert(appJs.includes('getRevenueConfirmationWorkOrderIds'), 'v4.10.1 revenue hardening should remain');
...
console.log('All v4.10.1 daily expense input checks passed.');
