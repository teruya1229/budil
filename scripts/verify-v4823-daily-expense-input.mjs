/**
 * Budil v4.9.2 daily expense input verification.
 */
...
console.log('== v4.9.2 daily expense input ==');
...
assert(appJs.includes('getRevenueConfirmationWorkOrderIds'), 'v4.9.2 revenue hardening should remain');
...
console.log('All v4.9.2 daily expense input checks passed.');
