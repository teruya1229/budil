...
console.log('\n== backup restore E2E ==');
{
  ...
  assert(e2e.exported.backupVersion === 'v4.8.2', 'backupVersion mismatch');
  assert(e2e.exported.appVersion === 'v4.8.2', 'appVersion mismatch');
...
console.log('\nAll v4.8.2 local checks passed.');
