/**
 * Budil v4.8.4 local verification (diagnostics + backup restore E2E)
 */
...
console.log('\n== backup restore E2E ==');
{
  ...
  assert(e2e.exported.backupVersion === 'v4.8.4', 'backupVersion mismatch');
  assert(e2e.exported.appVersion === 'v4.8.4', 'appVersion mismatch');
...
console.log('\nAll v4.8.4 local checks passed.');
