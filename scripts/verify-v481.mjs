/**
 * Budil v4.8.22 local verification (diagnostics + backup restore E2E)
 */
...
console.log('\n== backup restore E2E ==');
{
  ...
  assert(e2e.exported.backupVersion === 'v4.8.22', 'backupVersion mismatch');
  assert(e2e.exported.appVersion === 'v4.8.22', 'appVersion mismatch');
...
console.log('\nAll v4.8.22 local checks passed.');
