/**
 * Budil v4.8.6 local verification (diagnostics + backup restore E2E)
 */
...
console.log('\n== backup restore E2E ==');
{
  ...
  assert(e2e.exported.backupVersion === 'v4.8.6', 'backupVersion mismatch');
  assert(e2e.exported.appVersion === 'v4.8.6', 'appVersion mismatch');
...
console.log('\nAll v4.8.6 local checks passed.');
