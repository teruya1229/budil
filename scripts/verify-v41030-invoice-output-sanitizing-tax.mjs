/**
 * Budil v4.10.33 緊急修正 — 請求書出力サニタイズ・内税明細 verification.
 */
...
console.log('== v4.10.33 invoice-output-sanitizing-tax ==');
...
assert(indexHtml.includes('css/style.css?v=4.10.33'), 'v4.10.25 documents CSS cache buster must remain');
...
console.log('\nAll v4.10.33 invoice-output-sanitizing-tax checks passed.');
