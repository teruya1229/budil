/**
 * Budil v4.13.15 - confirmed revenue must come from current user input and an exact confirmation snapshot.
...
console.log('\nAll v4.13.15 revenue input confirmation checks passed.');
