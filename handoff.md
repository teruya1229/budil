...
| 項目 | 値 |
|------|-----|
| 最新公開URL | https://teruya1229.github.io/budil/?v=4.11.9 |
| 最新バージョン | v4.11.9 |
| v4.11.9 コープ・ヤマダ月次請求管理 | 正式合格 commit `c3a3e1a` / 全54 verify合格 / ローカルブラウザ点検OK / 公開反映待ち確認中 |
...
- **状態**: 正式合格（GitHub Pages CDN反映はpush直後に遅延あり。raw main・ローカルserveで確認済み）
- **commit**: `c3a3e1aae3d517b006628038d1a40a94069de83c`
- **verify**: 全54本合格
- **ブラウザ点検**: ローカル `http://127.0.0.1:3456/?v=4.11.9` で v4.11.9表示、入金予定に月次請求/1件ごと入金確認/月末請求確認ブロック、売上管理・利益管理の仲介料維持
